...
<body class="dash-admin admin-shell sidebar-collapsed @yield('body_class')">
    ...
    <nav class="dash-nav">
      @foreach($menu as $item)
        <a class="dash-link {{ $active === $item['route'] ? 'active' : '' }}"
          ...
          <span class="dash-link-text">{{ $item['label'] }}</span>
        </a>
      @endforeach
    </nav>
